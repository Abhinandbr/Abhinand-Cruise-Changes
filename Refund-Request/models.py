...
class Booking(models.Model):
    ...
    status = models.CharField(
        max_length=50,
        choices=[('Pending', 'Pending'), ('Confirmed', 'Confirmed'), ('Canceled', 'Canceled'), ('Paused', 'Paused')],
        default='Pending'  
    )
...
class RefundRequest(models.Model):
    ...
    final_price = models.DecimalField(max_digits=10, decimal_places=2, default= 0.00)  # Final price
    notes = models.TextField(blank=True, null=True)  # Additional notes
    name = models.CharField(max_length=100, default="unknown")  # Add this line for the name field
...
class JobApplication(models.Model):
    ...
    nationality = models.CharField(max_length=50)  # Optional additional field
